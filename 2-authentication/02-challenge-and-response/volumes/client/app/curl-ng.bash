...
# echo;はただの改行。
echo "wrong url";
curl -v server:3000/wrong; echo;echo;

echo "incorrect username";
curl -v server:3000/get-challenge?username=wrong; echo;echo;

echo "incorrect hash";

echo "=== 1. チャレンジ文字列を取得中 ==="
RESPONSE=$(curl -v server:3000/get-challenge?username=user1); echo;echo;
...
echo -e "\n=== 2. レスポンス（ハッシュ値）を計算中 ==="
# 「チャレンジ + パスワード」の文字列を作成
RAW_STRING="${CHALLENGE}wrong-password"
